# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in ProteinDigest.
...
import ProteinDigest
from ProteinDigest import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': ProteinDigest.model,
    'DBSession': ProteinDigest.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "df5a658f-4af2-419d-acfb-0291594be6b6",
